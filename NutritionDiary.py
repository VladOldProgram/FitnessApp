...
class Example(tk.Frame):
    ...
    def init_ui(self):
        ...
        self.tree = ttk.Treeview(frame, columns=('intDoctorId', 'txtProductName', 'txtProductWeight', 'txtProductProteins', 'txtProductFats', 'txtProductCarbohydrates', 'txtProductCalories'), height=34, show='headings')
